...
run(function()
    ...
    local LimitItem
    local Mouse
    local TowerSpeed -- New slider for tower speed
    local adjacent, lastpos, label = {}, Vector3.zero

    -- Populate adjacent positions
    for x = -3, 3, 3 do
        for y = -3, 3, 3 do
            for z = -3, 3, 3 do
                local vec = Vector3.new(x, y, z)
    ...
    -- Helper function to clamp positions near corners
    ...
    -- Helper function to find the closest block position
    ...
    -- Helper function to check adjacent positions for blocks
    ...
    -- Helper function to get the block for scaffolding
